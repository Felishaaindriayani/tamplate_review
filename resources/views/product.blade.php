    ...
    <section class="product product-info">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span class="devider">/</span>
                <span><a href="{{url('product')}}">Product Details</a></span>
            </div>
                            ...
                            <div class="swiper product-top">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-img-14.webp')}}"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-slider-img-1.webp')}}"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-slider-img-2.webp')}}"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-slider-img-3.webp')}}"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-slider-img-1.webp')}}"
                            ...
                            <div class="swiper product-bottom">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-img-16.png')}}"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-img-17.png')}}"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{asset('front/assets/images/homepage-one/product-img/product-slider-img-2.webp')}}"
