        ...
        <div class="category-section">
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/dresses.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/bags.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/sweaters.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/shoes.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/gift.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="600">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/sneakers.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/watch.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/ring.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/cap.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/glass.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                <div class="wrapper-img">
                    <img src="{{asset('front/assets/images/homepage-one/category-img/baby.webp')}}" alt="dress">
                </div>
                <div class="wrapper-info">
            ...
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-1.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-2.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-3.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-4.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-5.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-6.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-7.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-8.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-9.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-10.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-11.webp')}}" alt="img">
                    </a>
                </div>
            </div>
            <div class="product-wrapper">
                <div class="wrapper-img">
                    <a href="product-sidebar.html">
                        <img src="{{asset('front/assets/images/homepage-one/brand-img-12.webp')}}" alt="img">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="best-product-section">
            <div class="row g-4">
                ...
                <div class="col-xl-2 col-md-4">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{asset('front/assets/images/homepage-one/product-img/product-img-11.webp')}}"
                                alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="ratings">
                ...
                <div class="col-xl-2 col-md-4">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{asset('front/assets/images/homepage-one/product-img/product-img-13.webp')}}"
                                alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="ratings">
                ...
                <div class="col-xl-2 col-md-4">
                    <div class="product-wrapper" data-aos="fade-up">
                        <div class="product-img">
                            <img src="{{asset('front/assets/images/homepage-one/product-img/product-img-12.webp')}}"
                                alt="product-img">
                        </div>
                        <div class="product-info">
                            <div class="ratings">
