    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="{{url('user')}}">Dashboard</a></span>
            </div>
                                        ...
                                        <div class="img-upload-section">
                                            <div class="logo-wrapper">
                                                ...
                                                <div class="logo-upload">
                                                    <img src="{{asset('front/assets/images/homepage-one/sallers-cover.png')}}" alt="upload"
                            ...
                            <div class="payment-section">
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{asset('front/assets/images/homepage-one/payment-img-1.png')}}" alt="payment">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{asset('front/assets/images/homepage-one/payment-img-2.png')}}" alt="payment">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{asset('front/assets/images/homepage-one/payment-img-3.png')}}" alt="payment">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{asset('front/assets/images/homepage-one/payment-img-4.png')}}" alt="payment">
                                        </div>
                                        <div class="wrapper-content">
