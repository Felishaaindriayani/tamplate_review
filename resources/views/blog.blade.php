            ...
            <div class="blog-section latest-section">
                <div class="row g-5">
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            <div class="wrapper-img">
                                <img src="{{asset('front/assets/images/homepage-one/about/blog-img-1.webp')}}" alt="img">
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            <div class="wrapper-img">
                                <img src="{{asset('front/assets/images/homepage-one/about/blog-img-2.webp')}}" alt="img">
                            </div>
                            <div class="wrapper-info">
                                <div class="wrapper-data">
                                    <div class="admin wrapper-item">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            <div class="wrapper-img">
                                <img src="{{asset('front/assets/images/homepage-one/about/blog-img-3.webp')}}" alt="">
                            </div>
                            <div class="wrapper-info">
                                <div class="wrapper-data">
                                    <div class="admin wrapper-item">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            <div class="wrapper-img">
                                <img src="{{asset('front/assets/images/homepage-one/about/blog-img-1.webp')}}" alt="">
                            </div>
                            <div class="wrapper-info">
                                <div class="wrapper-data">
                                    <div class="admin wrapper-item">
